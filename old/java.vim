...
syn match javaCustomOps "+\|-\|*\|/\|%"
syn match javaCustomOther "<\|>\|=\|;\|\.\|,"
...
JavaHiLink javaParen Error
JavaHiLink javaParen1 Error
JavaHiLink javaParen2 Error
...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaCustomOps      Boolean
  JavaHiLink javaCustomParen    Include
  JavaHiLink javaCustomOther    Conditional
endif
